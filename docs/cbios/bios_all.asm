...
VERIFY_SECTOR:
    call    SET_IX_READ          ; reset IX to VDDTABLE and prepare for read
    ld      c,FDCDATA            ; port to be used in "ini"
    ld      h,(ix+IX_DSKBUF+1)   ; hl points to EPROM_DISKBUFPTR
    ld      l,(ix+IX_DSKBUF)     ; poteva anche scriversi come ld hl,BUFEPROM
    ld      a,7Fh
