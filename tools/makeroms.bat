rem video card character generator ROMs
...
rem test ROM by Gabriele Rossi
rem call node bin2js -i ..\roms\GPMON007.bin                -o ..\roms\rom.GPMON007.js     -n rom_GPMON007

call node bin2js -i ..\roms\scheda2\U1-MON1512.bin          -o ..\roms\rom.U1MON1512.js   -n rom_U1MON1512
call node bin2js -i ..\roms\scheda2\U3-FDC.BIN              -o ..\roms\rom.U3FDC.js       -n rom_U3FDC

call node bin2js -i ..\roms\scheda4\T20_V24.BIN             -o ..\roms\rom.T20V24.js      -n rom_T20V24
