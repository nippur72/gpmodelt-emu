...
call node bin2js -i ..\roms\machine2\U1-MON24.2.bin     -o ..\roms\rom.MON24_2         -n rom_MON24_2
call node bin2js -i ..\roms\machine2\U2-SYS2K-482.bin   -o ..\roms\rom.SYS2K_482       -n rom_SYS2K_482
call node bin2js -i ..\roms\machine2\U3-RIG02-U.BIN     -o ..\roms\rom.RIG02_U         -n rom_RIG02_U
